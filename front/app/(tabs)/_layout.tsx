  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "",
          tabBarIcon: ({ color }) => <IconSymbol size={28} name="briefcase.fill" color="white" />,
        }}
      />
      <Tabs.Screen
        name="absences"
        options={{
          title: "",
          tabBarIcon: ({ color }) => <IconSymbol size={28} name="person.crop.circle.badge.xmark" color="white" />,
        }}
      />
      <Tabs.Screen
        name="profile"
